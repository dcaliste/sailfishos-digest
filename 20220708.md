...
Post scriptum : summer (currently in the north hemisphere) is often the period for vacations and I'll be off for some time. I'll still be looking at Github news and forum discussions from time to time but I'll not really be able to write these digests. If anyone would like to replace me for a while, please feel free to do it and contact @flypig to add it to the community letter. Otherwise, you should be able to read the next repo digest on August, 25th. Enjoy the summer ; )